...
const Aboutus = () => {
    return (
        <div className='p-3'>
            <h3 class="mt-4">Your home for health</h3>
            <p class="text-start">Bdcare is the first and largest innovative online healthcare startup, built with a mission to create a “one-stop” healthcare platform for Doctors & Users. Bdcare is created with a vision to provide easy access for mass people to the healthcare system. We are technologically driven with all medical needs.</p>

            <h2>We provide :</h2>
            <p class="text-start">Doctors’ database: Authentic details of the doctors’ are maintained in Cure Health database which lead to users’ trust.
